...
document.addEventListener('DOMContentLoaded', () => {
  window.CONFIG = {
    ...
    textPosition: {
      x: 60,          // Distance from the left edge
      y: 254,         // Distance from the top edge
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            actions: [
              'Register for and attend one Career Center workshop on industry trends or job search preparation (resume building, interview strategies, etc.). Link: https://news.csun.edu/organizer/career-center/?eventDisplay=past'
            ]
          }
        ]
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            actions: [
              'Meet with someone that you trust (mentor, professor, supervisor, alumni, trusted family or friend) to help guide your decision on a major or career path. Link: http://csun.protopia.co/'
            ]
          }
        ]
      },
        ...
        options: [
          {
            ...
            actions: [
              'Meet with a professional to job shadow or conduct an informational interview. Link: https://www.csun.edu/careerlink/handshake-jobs-internships-more/informational-interviewing',
              'Link: https://www.csun.edu/careerlink/handshake-jobs-internships-more/job-shadowing',
              'Link: https://www.csun.edu/alumni/corporate-connect'
            ]
          },
          {
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            actions: [
              'Complete one job-simulation in Forage that relates to your major or career path. Link: https://www.csun.edu/careerlink/career-readiness-and-planning/forage-experience-real-world-job-trainings'
            ]
          },
          {
          ...
          },
          {
            ...
            actions: [
              'Schedule a career counseling appointment to complete a mock interview and receive feedback. Link: https://www.csun.edu/careerlink/job-search-preparation/interviewing'
            ]
          }
        ]
      }
