// all your questions, options, actions, and PDF template URL in one place:
window.CONFIG = {
  ...
  questions: [
    ...
    },
    {
      id: "animal",
      type: "radio",
      label: "What type of animal do you like?",
      options: [
    ...
    },
    {
      id: "location",
      type: "radio",
      label: "If you could go anywhere right now where would you go?",
      options: [
        ...
        { value: "park",  label: "Park",  actions: ["Visit https://google.com and find a new park to visit."] },
    ...
    },
    {
      id: "transport",
      type: "radio",
      label: "Favorite method of transportation",
      options: [
        ...
        { value: "boat",  label: "Boat",  actions: ["Go to Long Beach to take a ferry ride."] }
      ]
    }
  ]
};
